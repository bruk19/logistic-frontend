    ...
    if (contract && window.ethereum !== undefined) {
      try {
        ...
        if (currentStage === 'Product Ordered') {
          ...
          console.log(
            'Product moved to supplier. Transaction receipt:',
            receipt
          );
          window.alert(
    ...
    if (contract && window.ethereum !== undefined) {
      try {
        ...
        if (currentStage === 'Product on Raw Material Supply Stage') {
          ...
          const receipt = await tx.wait();
          console.log(
            'Product moved to Manufacture. Transaction receipt:',
            receipt
          );
          window.alert(
    ...
    if (contract && window.ethereum !== undefined) {
      try {
        ...
        if (currentStage === 'Product on Manufacture Stage') {
          ...
          const receipt = await tx.wait();
          console.log(
            'Product moved to Distributer. Transaction receipt:',
            receipt
          );
          window.alert(
            'The product has been added to the distributor successfully'
          );

          setDid('');
        } else {
          window.alert(
            'the Product is not in manufacture stage, cannot move to distributor'
          );
        }
      } catch (error) {
    ...
    if (contract && window.ethereum !== undefined) {
      try {
        ...
        if (currentStage === 'Product on Distribution Stage') {
          ...
          const receipt = await tx.wait();
          console.log(
            'Product moved to Retailer. Transaction receipt:',
            receipt
          );
          window.alert(
            'The product has been added to the retailer successfully'
          );

          setRid('');
        } else {
          window.alert(
            'the Product is not in manufacture stage, cannot move to retailer'
          );
        }
      } catch (error) {
    ...
    if (contract && window.ethereum !== undefined) {
      try {
        ...
        if (soldProduct === 'Product on Retail Stage') {
          ...
          window.alert(
            'the Product is not in retailer stage, cannot move to retailer'
          );
        }
      } catch (error) {
    ...
    <div className="w-full mt-6">
      ...
      <div className="w-full m-10">
        <div className="border-b-[2px] py-2 my-3">
          <h2 className="tx-2xl font-bold mt-3">
            Step 1: Supply Raw Material (Only a registered Raw Material
            supplier)
          </h2>
          <input
        ...
        <div className="border-b-[2px] py-2 my-3">
          <h2 className="tx-2xl font-bold mt-3">
            Step 2: Manufacture (Only a registered Manufacturer)
          </h2>
          <input
            className="border-gray-300 border rounded px-3 py-2 flex-1 mx-2"
            type="text"
        ...
        <div className="border-b-[2px] py-2 my-3">
          <h2 className="tx-2xl font-bold mt-3">
            Step 3: Distribute (Only a registered Distributor)
          </h2>
          <input
            className="border-gray-300 border rounded px-3 py-2 flex-1 mx-2"
            type="text"
        ...
        <div className="border-b-[2px] py-2 my-3">
          <h2 className="tx-2xl font-bold mt-3">
            Step 4: Retail (Only a registered Retailer)
          </h2>
          <input
            className="border-gray-300 border rounded px-3 py-2 flex-1 mx-2"
            type="text"
        ...
        <div className="border-b-[2px] py-2 my-3">
          <h2 className="tx-2xl font-bold mt-3">
            Step 5: Sold (Only a registered Retailer)
          </h2>
          <input
            className="border-gray-300 border rounded px-3 py-2 flex-1 mx-2"
            type="text"
